                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">个人照片</a></li>
                            </ul>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset class="form-horizontal">
                                            <div class="form-group"><label class="col-sm-2 control-label">教练ID:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_id" value=${coach.coach_id } readonly="readonly"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">姓名:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_name" value="${coach.coach_name }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">性别:</label>
                                            <div class="col-sm-10">
                                         		<select class="form-control" name="coach_sex">
	                                                        <option value='M' <c:if test="${coach.coach_sex eq 'M'}">selected </c:if>> 男</option>
	                                                        <option value='F' <c:if test="${coach.coach_sex eq 'F'}">selected </c:if>> 女</option>
	                                            </select>
                                            </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">证书:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control"  name="coach_quality" value="${coach.coach_quality }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">描述:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control"  name="coach_text" value="${coach.coach_text }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">主要课程:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_maintech"  value="${coach.coach_maintech }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">身高:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control"  name="coach_height" value="${coach.coach_height }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">体重:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_weight" value="${coach.coach_weight }"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">课程资费:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_cost" value="${coach.coach_cost }"></div>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-stripped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<form  id ="form2" action="CoachEditPic.do" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-white" onclick="window.location.href='CoachDeleteTX.do?coach_id=${sessionScope.coach.coach_id }'">删除照片</button>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
