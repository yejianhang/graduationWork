                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-2" class="tab-pane active">
                                    <div class="panel-body">
										<form action="InsertCoach.do" method="post">
                                        <fieldset class="form-horizontal">
                                            <div class="form-group"><label class="col-sm-2 control-label">教练ID:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_id" value="${new_coachid}"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">姓名:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_name"></div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">证书:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_quality" ></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">描述:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_text" ></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">主要课程:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_maintech"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">身高:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control"name="coach_height"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">体重:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_weight"></div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">课程费用:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="coach_cost"></div>
                                            </div>
