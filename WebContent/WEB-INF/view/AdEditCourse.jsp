...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg" style="min-height: 1263px;">
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
			<input type="hidden" id="tech_id" value="${tech.tech_id}">
            <div class="row">
                <div class="col-lg-12">
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">课程名称:</label>
                                                <div class="col-sm-10">
	                                                <select class="form-control" id="course_id">
                                                        ...
                                                        <option value='${course.course_id}' <c:if test="${course.course_id eq tech.course_id}">selected</c:if>> ${course.course_name }</option>
		                                           		</c:forEach>
		                                            </select>
	                                            </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">教练名称:</label>
                                                <div class="col-sm-10">
	                                                <select class="form-control" id="coach_id">
                                                        ...
                                                        <option value='${coach.coach_id}'<c:if test="${coach.coach_id eq tech.coach_id}">selected</c:if>> ${coach.coach_name }</option>
		                                           		</c:forEach>
		                                            </select>
	                                            </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">课程开始时间:</label>
                                               	<div class="col-sm-10">
			                             		 	<div class="input-group date" id='date1'>  
										                <input type="text" class="form-control" value="${tech.tech_time }" id="tech_time"/>  
                                            ...
                                            <div class="form-group"><label class="col-sm-2 control-label">上课地点:</label>
                                                <div class="col-sm-10">
	                                                <select class="form-control" id="tech_palace">
                                                        ...
                                                        <option value='${palace.palace_id }' <c:if test="${palace.palace_id eq tech.tech_palace}">selected</c:if>>${palace.palace_name }</option>
		                                           		</c:forEach>
		                                            </select>
	                                            </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-2 control-label">总人数:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" value="${tech.tech_num }" id="tech_num" onkeyup="value=value.replace(/[^\d]/g,'')"></div>
                                            </div>
