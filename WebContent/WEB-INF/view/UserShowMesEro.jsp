    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                	<input type="hidden" id="isBookCoach" value="${isBookCoach}"> 
                    <h2>空白页面</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="wrapper wrapper-content">
                <div class="middle-box text-center animated fadeInRightBig">
                    <h3 class="font-bold">查看失败</h3>
                    <div class="error-desc">
                       你的体测信息未录入
                        <br><a href="EnterChat1.do" class="btn btn-primary m-t" onclick="return checkIsBooKCoach()">联系您的私聊</a>
                    </div>
                </div>
            </div>
...
<script>
	function checkIsBooKCoach(){
		var isbook=$("#isBookCoach").val();
		if(isbook==1){
    		return true;
    	}
		if(isbook==0){
