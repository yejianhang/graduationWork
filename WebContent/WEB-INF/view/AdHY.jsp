                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny footable-loaded tablet breakpoint" data-page-size="15">
                                ...
                                <tr>
                                    ...
                                    <th data-toggle="true" class="footable-visible footable-sortable footable-first-column">会员ID</th>
                                    <th data-hide="phone" class="footable-visible footable-sortable">会员名称</th>
                                    <th data-hide="phone" class="footable-visible footable-sortable">入会时间/入会期限</th>
                                    
                                    <th class="text-right footable-visible footable-last-column" data-sort-ignore="true"><button class="btn btn-sm btn-primary" onclick="window.location.href='IntoInsertHY.do'">新增</button></th>

                                </tr>
                                </thead>
                                <c:forEach items="${list}" var="user">
                                <tr class="footable-even" style=""  id="${user.user_id}">
                                    ...
                                    <td class="footable-visible">
                                        ${user.user_menberStart} / ${user.user_menberTime}月
                                    </td>
                                   
                                    <td class="text-right footable-visible footable-last-column">
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-primary" onclick="window.location.href='AdShoHYDetail.do?user_id='+'${user.user_id}'" >查看</button>
                                            <button class="btn btn-sm btn-primary" onclick="window.location.href='AdEditHYDetail.do?user_id='+'${user.user_id}'" >编辑</button>
                                            <button class="btn btn-sm btn-primary" id=${user.user_id} onclick="deleteUser(this)">删除</button>
                                        </div>
                                    </td>
                                </tr>
                               </c:forEach>
