...
<body>
					...
					<div class="col-md-5 order-md-1 signin-left-column bg-white px-5" style="height: 783px;">
						<form action="CoachLogin.do" method="post">
							<div class="form-group">
								...
								<input type="text" class="form-control"   name="coach_id" id="coach_id">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1" class="active">密码</label>
								<input type="password" class="form-control" id="coach_passwd" placeholder="Password" name="coach_passwd">
							</div>
	...
	<script>
	function checkLog(){
		 var result=$("#coach_id").val();
		 var password =$("#coach_passwd").val();
		 if(result == "" ){
			swal("CoachID不能为空!!!");
			return false;
		 }
